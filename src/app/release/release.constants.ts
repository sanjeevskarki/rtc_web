...
export const EXTERNAL_WITH_HANDOVER_LOWERCASE = 'externalwithhandover';
export const EXTERNAL_WITHOUT_HANDOVER_LOWERCASE = 'externalwithouthandover';
export const INTERNAL_LOWERCASE = 'internal';
export const MILESTONE_LOWERCASE = 'milestone';
export const TYPE_LOWERCASE = 'type';
